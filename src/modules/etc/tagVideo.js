...
export default async function tagVideo(sdk, uniqueUrl, tagInfoObject) {
  ...
  playBtn.setAttribute('src', 'https://domein.com/domein-modules/images/icons_line_play_24px.svg');
      ...
      if (selected !== this.prevState.selected) {
        ...
        if (selected) {
          ...
          if (selected === lobbyTagId || selected === artTagId) {
            ...
            attachmentVideo.setAttribute('src', `https://domein.com/divein/${uniqueUrl}/public/${videoName}.mp4`);
